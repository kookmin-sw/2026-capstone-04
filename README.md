...
| 이름 | 역할 |
| --- | --- |
| 허승범 | 백엔드 API, JWT 인증, 배포, 테스트 |
| 임은빈 | UI/UX 구성, 문서화, 사용자/운영자 매뉴얼, 배포 가이드, 발표자료 |
| 송승은 | 실시간 분석 기능 개발, 화면 감지 및 캡처 흐름 구현 |
| 지수연 | 프론트엔드 UI, 사용자 흐름 및 화면 구성 |
| 안재훈 | DB 설계, AI 챗 기능, Gemini 연동, 프롬프트 설계 |
